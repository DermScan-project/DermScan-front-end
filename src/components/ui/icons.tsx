...
export const EyeOffIcon = (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6">
    ...
    <path d="M10.6 5.1A10.6 10.6 0 0112 5c6.5 0 10 7 10 7a17.3 17.3 0 01-3.1 4M6.5 6.6C3.9 8.3 2 12 2 12s3.5 7 10 7a9.6 9.6 0 004.4-1" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M14.1 14.1a3 3 0 01-4.2-4.2" strokeLinecap="round" />
  </svg>
);
