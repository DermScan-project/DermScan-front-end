// app/medecin/notifications/page.tsx
"use client";

import { useEffect, useState } from "react";
import { useRouter } from "next/navigation";
import PortalHeader from "@/components/ui/PortalHeader";
import NotificationItem from "@/components/patient/NotificationItem"; // reused, generic component
import {
  ...
  return (
    <div className="min-h-screen bg-papier">
      <PortalHeader
        ...
        onBack={() => router.push("/medecin/dashboard")}
      />
      ...
      <div className="p-5 max-w-full mx-auto flex flex-col gap-3">
        ...
        {!loading && notifications.length === 0 && (
          <div className="flex flex-col items-center text-center py-16 gap-2">
            ...
            <p className="text-xs text-ardoise/70">Vous serez notifié ici des mises à jour de vos patients et rendez-vous.</p>
          </div>
        )}
